...
public sealed record IntField(string Name, int Min, int Max, int DefaultInt) : EffectField(Name, DataType.Int, DefaultInt);
/// <summary>
...
public sealed record FloatField(string Name, float Min, float Max, float Step, float DefaultFloat) : EffectField(Name, DataType.Float, DefaultFloat);
...
public sealed record StringField(string Name, string DefaultString) : EffectField(Name, DataType.String, DefaultString ?? "");
